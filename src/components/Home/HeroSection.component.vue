<template>
    <BaseSection custom-section-class="hero" custom-layout-class="hero__layout">
        <template #sectionOutterAddon>
            <div class="hero-shape"></div>
        </template>
        <template #default>
            <div class="hero-heading--wrapper">
                <h1 class="heading">Tavo savanorystės kelionė prasideda čia</h1>
                <h2 class="sub-heading">
                    Platforma, kurioje patogiai, greitai ir lengvai rasite sau
                    tinkamiausią savanorystės veiklą
                </h2>
                <CustomButton
            ...
            <img
                ...
                src="@/assets/illustrations/travel-green_no-bg.svg"
            />
        </template>
    </BaseSection>
</template>
...
.hero-shape {
    ...
    height: 7rem;
    top: calc(100% - var(--pd-section-vertical));
