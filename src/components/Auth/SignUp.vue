<template>
  <form class="form">
    <div class="form__controls">
      ...
      <InputControl label="Pakartoti slaptažodį" input-type="password" input-name="repeat" />
    </div>
    <CustomButton
      ...
      button-type="submit"
      button-title="Mygtukas registruotis"
    />
  </form>
  <p>
    Jau turi paskyrą?
    <RouterLink class="auth__link" to="/auth/signin">Prisijunk</RouterLink>
  </p>
</template>
